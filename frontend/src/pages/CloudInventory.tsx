      ...
      {!selectedScanId ? (
        ...
        <>
          ...
          {data.costManagement.length > 0 && (
            <SectionGate featureKey="section.cloud.cost_management">
              <section>
          ...
          {/* ── Cloud Accounts ─────────────────────────────────────────────── */}
          <SectionGate featureKey="section.cloud.account_connections">
            <section>
          ...
          {data.mappingGaps.length > 0 && (
            <SectionGate featureKey="section.cloud.tag_alignment">
              <section>
          ...
          {data.detectedProviders.length > 0 && (
            <SectionGate featureKey="section.cloud.tag_inventory">
              <section>
